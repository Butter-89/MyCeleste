#undef CELESTEREMADE_API
#undef CELESTEREMADE_VTABLE
...
#define UE_PROJECT_NAME CelesteRemade
...
#define CELESTEREMADE_VTABLE DLLEXPORT_VTABLE
#define CELESTEREMADE_API DLLEXPORT
